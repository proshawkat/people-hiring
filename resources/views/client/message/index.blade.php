                ...
                <div class="col-md-12 col-xl-12 chat">
                    <div class="card">
                        ...
                        <div class="card-body msg_card_body">
                            @if(\App\Conversation::where('from', Auth::guard('clients')->user()->id)->count() == 0)

                                @foreach(\App\Conversation::where('to', Auth::guard('clients')->user()->id)->get() as $thread)

                                    <div class="d-flex justify-content-start mb-4">
                                        <div class="img_cont_msg">
                                            <img src="https://static.turbosquid.com/Preview/001292/481/WV/_D.jpg" class="rounded-circle user_img_msg">
                                        </div>
                                        <?php $msg =  \App\ConversationReply::where('conversation_id', $thread->id)->where('to', $thread->to)->orderBy('created_at','desc')->first()  ?>
                                ...
                                @endforeach
                            @else
                                @foreach(\App\Conversation::where('from', Auth::guard('clients')->user()->id)->get() as $thread)
                                    <div class="d-flex justify-content-end mb-4">
                                        <?php $msg =  \App\ConversationReply::where('conversation_id', $thread->id)->where('from',$thread->to)->orderBy('created_at','desc')->first()  ?>
