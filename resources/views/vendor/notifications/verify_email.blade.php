...
<head>
    ...
    <style type="text/css">
        ...
        .email-body {
            padding: 87px 28px 38px 28px;
            width: 100%;
            background-color: #F6F5F3;
            font-size: 12pt;
            font-family: "Sheep & Pelle Light";
        }
...
<body class="o_body o_bg-white" style="width: 100%;margin: 0px;padding: 0px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #ffffff;">
    ...
    <table class="email-body">
        ...
        <tr>
            <td colspan="3" class="text-center" style="padding-bottom: 55px">
                <a class="btn-outline" href="{{ $actionUrl }}">Verify Email Address</a>
            </td>
        </tr>
        <tr>
            <td colspan="3">If you did not create an account, no further action is required.</td>
        </tr>
        <tr>
            <td colspan="3" class="social-icons-title">Follow us</td>
        </tr>
        <tr>
        ...
        <tr class="footer-menu">
            <td style="width: 40%;">
                <a style="" href="">TERMS & CONDITIONS</a>
            </td>
            <td style="width: 28%;" class="text-center">
                <a href="">PRIVACY POLICY</a>
            </td>
            <td style="width: 32%;" class="text-right">
                <a href="">CONTACT US</a>
            </td>
        </tr>
    </table>
