    ...
    <div class="row">
        <div class="col-md-offset-6 col-md-6 offset-3">
            ...
            <div class="card-body msg_card_body">
                @if(\App\Conversation::where('from',Auth::id())->count() == 0)

                    @foreach(\App\Conversation::where('to',Auth::id())->get() as $thread)
                    ...
                    @endforeach
                @else
                    @foreach(\App\Conversation::where('from',Auth::id())->get() as $thread)
