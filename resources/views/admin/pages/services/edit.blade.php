		                        ...
		                        <form action="{{ url('admin/service/update') }}" method="post" enctype="multipart/form-data">
		                            ...
		                            <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" id="short_details" name="short_details" placeholder="Short Description">{{ $service->short_details }}</textarea>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="details">Description</label>
                                            <textarea class="form-control" id="details" name="details" placeholder="Description">{{ $service->details }}</textarea>
                                        </div>
		                                <div class="form-group col-md-6">
